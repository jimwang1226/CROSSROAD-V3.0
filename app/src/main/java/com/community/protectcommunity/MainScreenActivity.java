...
public class MainScreenActivity extends AppCompatActivity implements View.OnClickListener, View.OnHoverListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        what_is_bully_btn = (Button) findViewById(R.id.what_is_bully_btn);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.fact_sheet_btn:
                ...
                mHomeWatcher.stopWatch();
                break;
            case R.id.what_is_bully_btn:
                System.out.println("click what is bully");
                SoundUtil.playSound(soundID);
                goWhatIsBullyActivity();
                mHomeWatcher.stopWatch();
                break;
            default:
                break;
    ...
    public void goWhatIsBullyActivity(){
