...
public class FactSheetActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        returnButton = (Button) findViewById(R.id.fact_sheet_return_to_mainscreen_button);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.fact_sheet_return_to_mainscreen_button:
    ...
    private void initFacts() {
        Fact fact1 = new Fact("Victoria 7 to 9 male and female ratio", R.drawable.male_female_ratio);
        factList.add(fact1);
        Fact fact2 = new Fact("Victoria student enrollment statistics", R.drawable.student_enrollment);
        factList.add(fact2);
        Fact fact3 = new Fact("School bully, a serious problem in Victoria", R.drawable.school_bully);
        factList.add(fact3);
        Fact fact4 = new Fact("School bully trend from 2006 to 2018", R.drawable.bully_trend);
        factList.add(fact4);
        Fact fact5= new Fact("Speech difficulty situation is severe in Victoria", R.drawable.speech_difficulty);
        factList.add(fact5);
    }
